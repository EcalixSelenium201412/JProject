...
public class DataDriveXLS {
	...
	public DataDriveXLS(String path) {
	...
	public static void main(String arg[]) throws IOException {
		...
		DataDriveXLS datatable = null;

		datatable = new DataDriveXLS("C:/Selenium/Mobile/TestData/TestData.xlsx");
